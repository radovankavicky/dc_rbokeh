...
#### - Let's make it transparent too (Pipe it via theme_legend).
#### - Let's change the default font too (everybody ♥ Garamond, right?).
```{r, echo=TRUE, message=FALSE, warning = FALSE}
library(rbokeh)
...
#### - Let's make it bigger & Garamond too (Pipe it via theme_title).
```{r, echo=TRUE, message=FALSE, warning = FALSE}
library(rbokeh)
...
#### - Let's change major_label font too (everybody still ♥ Garamond, right?).
```{r, echo=TRUE, message=FALSE, warning = FALSE}
library(rbokeh)
